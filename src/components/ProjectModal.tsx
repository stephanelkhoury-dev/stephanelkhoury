...
import { faExternalLinkAlt, faTag, faCalendarAlt } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="lg:hidden space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            {(project.features || project.challenges) && (
              <div className="space-y-4 sm:space-y-6 pt-4 border-t border-white/10">
                {project.features && (
                  <div>
                ...
                {project.challenges && (
                  <div>
                    <h3 className="text-base sm:text-lg font-semibold text-white mb-2 sm:mb-3">Technical Challenges</h3>
                    <ul className="space-y-2">
