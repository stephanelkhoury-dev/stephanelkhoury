        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8 }} className="space-y-12">
            <div>
              ...
              <p className="text-zinc-400 text-lg max-w-md">{content.subtitle}</p>
            </div>

            <div className="space-y-6">
              {content.email && (
              <a href={`mailto:${content.email}`} className="flex items-center gap-4 text-zinc-300 hover:text-blue-400 transition-colors group">
              ...
              {content.phone && (
                <a href={`tel:${content.phone}`} className="flex items-center gap-4 text-zinc-300 hover:text-blue-400 transition-colors group">
                  <div className="w-12 h-12 rounded-full bg-zinc-900 border border-zinc-800 group-hover:border-blue-500/50 flex items-center justify-center text-zinc-400 group-hover:text-blue-400 transition-all">
                    <Phone className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="text-sm font-medium text-zinc-500">Phone</h4>
            ...
            <div className="pt-8 border-t border-zinc-800">
              ...
              <div className="flex gap-4">
                <a href={content.linkedin || '#'} target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-zinc-900 border border-zinc-800 hover:border-blue-500 hover:bg-blue-600/10 flex items-center justify-center text-zinc-400 hover:text-blue-400 transition-all">
                  <Linkedin className="w-5 h-5" />
                </a>
                <a href={content.github || '#'} target="_blank" rel="noreferrer" className="w-12 h-12 rounded-full bg-zinc-900 border border-zinc-800 hover:border-zinc-500 hover:bg-zinc-800 flex items-center justify-center text-zinc-400 hover:text-white transition-all">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="bg-zinc-900/50 border border-zinc-800/80 p-8 md:p-10 rounded-3xl backdrop-blur-sm">
