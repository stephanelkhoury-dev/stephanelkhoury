          ...
          {items.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-zinc-100/70 dark:bg-zinc-900/40 border border-zinc-300/80 dark:border-zinc-800/80 p-8 rounded-2xl group transition-all duration-300 hover:bg-zinc-200/70 dark:hover:bg-zinc-800/50 hover:border-zinc-400 dark:hover:border-zinc-700 hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] hover:-translate-y-1 relative overflow-hidden"
              >
