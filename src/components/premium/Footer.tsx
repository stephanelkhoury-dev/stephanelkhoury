    ...
    <footer className="bg-zinc-950 border-t border-zinc-900 py-12 relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <button onClick={scrollToTop} className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-400 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all" aria-label="Scroll to top">
            <ArrowUp size={18} />
          </button>
        </div>
      </div>
