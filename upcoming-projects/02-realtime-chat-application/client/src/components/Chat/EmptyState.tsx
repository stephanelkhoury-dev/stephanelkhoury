  ...
  return (
    <div className="h-full flex items-center justify-center bg-gray-50">
      ...
      >
        ...
        >
          ...
          <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-500">Share images, documents, and more</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-500">Create groups for team collaboration</p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <p>💡 Tip: Use keyboard shortcuts like Ctrl+Enter to send messages quickly</p>
        </motion.div>
      </motion.div>
    </div>
  );
