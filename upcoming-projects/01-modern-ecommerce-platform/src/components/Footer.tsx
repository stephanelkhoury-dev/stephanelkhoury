        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Your trusted online destination for premium products with exceptional customer service.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.337-1.294C3.595 14.195 3.029 12.63 3.029 10.5c0-2.13.566-3.695 1.083-4.194.889-.804 2.04-1.294 3.337-1.294 1.297 0 2.448.49 3.337 1.294.517.499 1.083 2.064 1.083 4.194 0 2.13-.566 3.695-1.083 4.194-.889.804-2.04 1.294-3.337 1.294z"/>
                </svg>
              </a>
            </div>
          </div>
            ...
            <div className="mt-6">
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-white"
                />
